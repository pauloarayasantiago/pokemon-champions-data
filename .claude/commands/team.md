...
- [ ] Every item is available in Champions (NOT: Life Orb, Choice Band/Specs, Assault Vest, Rocky Helmet, Heavy-Duty Boots, Eviolite, Flame/Toxic Orb, Power Herb, Light Clay, Covert Cloak, Loaded Dice, Utility Umbrella)
...
```
## Team Overview
**Archetype:** [name] | **Speed Control:** [Tailwind/TR/Weather/None] | **Mega:** [name]
**Win Condition:** [1-2 sentences on how this team wins]
...
## Speed Tiers
[Team members' speeds relative to key benchmarks: Garchomp 102, Sneasler 150, Incineroar 60]
...
**Role:** [explanation]
**Key Calcs:** [relevant damage or speed benchmarks]
...
- NEVER recommend Choice Band, Choice Specs, Life Orb, Assault Vest, or other missing items
